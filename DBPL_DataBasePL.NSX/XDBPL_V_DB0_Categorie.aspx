<%@ Page Language="C#" MasterPageFile="~/DBPL/DBPL_MasterPage.master" AutoEventWireup="true"
 CodeFile="XDBPL_V_DB0_Categorie.aspx.cs" Inherits="XDBPL_V_DB0_Categorie" Title="" %>
...
<asp:Content ID="ContentForm" ContentPlaceHolderID="PlaceHolderForm" runat="server">
        ...
        <li>
            <ul>
                <li id="FFiltersTab_7" class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" clientidmode="Static" runat="server">
                    <ul>
                        <li>Filtres</li>
                        <li><TBfr:DBPL_ComboBox ID="FiltreId_typecategorie_7" Caption='<%# TemplateLabelValue(7,"LblFilterId_typecategorie")%>' ClientIDMode="Static" runat="server" /></li>
                        ...
                        <li><TBfr:DBPL_TextBox ID="FiltreOrdreaff_7" Caption='<%# TemplateLabelValue(7,"LblFilterOrdreaff")%>' ClientIDMode="Static" runat="server" /></li>
        ...
        <li>
            ...
            <TBfr:DBPL_PivotGrid ID="grid_7" OnInit="Page_InitPivotGrid" ClientIDMode="Static" runat="server" >
              ...
              <%--<Fields>
                    ...
                    <dx:PivotGridField ID="fId_typecategorie_7" FieldName="Id_typecategorie" />
                    <dx:PivotGridField ID="fLibelle_7" FieldName="Libelle" />
                    <dx:PivotGridField ID="fOrdreaff_7" FieldName="Ordreaff" />
    ...
    <asp:SqlDataSource ID="SqlDataSourceGrid_7" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataDBPL %>" runat="server" />
        ...
        <asp:SqlDataSource ID="SqlDataSourceFiltreId_typecategorie_7" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataDBPL %>" runat="server" />
