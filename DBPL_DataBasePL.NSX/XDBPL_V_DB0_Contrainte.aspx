<%@ Page Language="C#" MasterPageFile="~/DBPL/DBPL_MasterPage.master" AutoEventWireup="true"
 CodeFile="XDBPL_V_DB0_Contrainte.aspx.cs" Inherits="XDBPL_V_DB0_Contrainte" Title="" %>
...
<asp:Content ID="ContentForm" ContentPlaceHolderID="PlaceHolderForm" runat="server">
        ...
        <li>
            <ul>
                <li id="FFiltersTab_7" class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" clientidmode="Static" runat="server">
                    <ul>
                        <li>Filtres</li>
                        <li><TBfr:DBPL_ComboBox ID="FiltreId_planning_7" Caption='<%# TemplateLabelValue(7,"LblFilterId_planning")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:DBPL_TextBox ID="FiltreRef_7" Caption='<%# TemplateLabelValue(7,"LblFilterRef")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:DBPL_TextBox ID="FiltreAbreviation_7" Caption='<%# TemplateLabelValue(7,"LblFilterAbreviation")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:DBPL_TextBox ID="FiltreLibelle_7" Caption='<%# TemplateLabelValue(7,"LblFilterLibelle")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:DBPL_TextBox ID="FiltreCommentaire_7" Caption='<%# TemplateLabelValue(7,"LblFilterCommentaire")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:DBPL_ComboBox ID="FiltreId_typecontrainte_7" Caption='<%# TemplateLabelValue(7,"LblFilterId_typecontrainte")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:DBPL_CheckBox ID="FiltreRealisee_7" Caption='<%# TemplateLabelValue(7,"LblFilterRealisee")%>' ClientIDMode="Static" runat="server" /></li>
        ...
        <li>
            ...
            <TBfr:DBPL_PivotGrid ID="grid_7" OnInit="Page_InitPivotGrid" ClientIDMode="Static" runat="server" >
              ...
              <%--<Fields>
                    ...
                    <dx:PivotGridField ID="fId_planning_7" FieldName="Id_planning" />
                    <dx:PivotGridField ID="fRef_7" FieldName="Ref" />
                    <dx:PivotGridField ID="fAbreviation_7" FieldName="Abreviation" />
                    <dx:PivotGridField ID="fLibelle_7" FieldName="Libelle" />
                    <dx:PivotGridField ID="fCommentaire_7" FieldName="Commentaire" />
                    <dx:PivotGridField ID="fId_typecontrainte_7" FieldName="Id_typecontrainte" />
                    <dx:PivotGridField ID="fRealisee_7" FieldName="Realisee" />
    ...
    <asp:SqlDataSource ID="SqlDataSourceGrid_7" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataDBPL %>" runat="server" />
        ...
        <asp:SqlDataSource ID="SqlDataSourceFiltreId_planning_7" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataDBPL %>" runat="server" />
        <asp:SqlDataSource ID="SqlDataSourceFiltreId_typecontrainte_7" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataDBPL %>" runat="server" />
