<%@ Page Language="C#" MasterPageFile="~/DBPL/DBPL_MasterPage.master" AutoEventWireup="true"
 CodeFile="XDBPL_V_DB0_Realisation.aspx.cs" Inherits="XDBPL_V_DB0_Realisation" Title="" %>
...
<asp:Content ID="ContentForm" ContentPlaceHolderID="PlaceHolderForm" runat="server">
        ...
        <li>
            <ul>
                <li id="FFiltersTab_7" class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" clientidmode="Static" runat="server">
                    <ul>
                        <li>Filtres</li>
                        <li><TBfr:DBPL_DateEdit ID="FiltreDebut_7" Caption='<%# TemplateLabelValue(7,"LblFilterDebut")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:DBPL_ComboBox ID="FiltreId_employe_7" Caption='<%# TemplateLabelValue(7,"LblFilterId_employe")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:DBPL_TextBox ID="FiltreDuree_7" Caption='<%# TemplateLabelValue(7,"LblFilterDuree")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:DBPL_ComboBox ID="FiltreId_contrainterealisee_7" Caption='<%# TemplateLabelValue(7,"LblFilterId_contrainterealisee")%>' ClientIDMode="Static" runat="server" /></li>
        ...
        <li>
            ...
            <TBfr:DBPL_PivotGrid ID="grid_7" OnInit="Page_InitPivotGrid" ClientIDMode="Static" runat="server" >
              ...
              <%--<Fields>
                    ...
                    <dx:PivotGridField ID="fDebut_7" FieldName="Debut" />
                    <dx:PivotGridField ID="fId_employe_7" FieldName="Id_employe" />
                    <dx:PivotGridField ID="fDuree_7" FieldName="Duree" />
                    <dx:PivotGridField ID="fId_contrainterealisee_7" FieldName="Id_contrainterealisee" />
    ...
    <asp:SqlDataSource ID="SqlDataSourceGrid_7" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataDBPL %>" runat="server" />
        ...
        <asp:SqlDataSource ID="SqlDataSourceFiltreId_employe_7" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataDBPL %>" runat="server" />
        <asp:SqlDataSource ID="SqlDataSourceFiltreId_contrainterealisee_7" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataDBPL %>" runat="server" />
