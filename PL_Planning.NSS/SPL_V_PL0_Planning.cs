...
namespace Planning.NSS
{
    ...
    {
        public SPL_V_PL0_Planning(ITBfrStorageAccess storageAccess) : base(storageAccess) { }

        public override bool UniquenessCheck(TBfrData_List data_List, Object iHMObject, TBfrError_List errors)
        {
            var vData_List = (DPL_V_PL0_Planning)data_List;
            return new SDBPL_V_DB0_Planning(IStorageAccess).UniquenessCheck(iHMObject, errors, vData_List.DId, vData_List.DLibelle, vData_List.DAbreviation);
        }
