...
namespace Planning.NSS
{
    ...
    {
        public SPL_V_PL0_Version(ITBfrStorageAccess storageAccess) : base(storageAccess) { }

        public override bool UniquenessCheck(TBfrData_List data_List, Object iHMObject, TBfrError_List errors)
        {
            var vData_List = (DPL_V_PL0_Version)data_List;
            return new SDBPL_V_DB0_Version(IStorageAccess).UniquenessCheck(iHMObject, errors, vData_List.DId, vData_List.DId_planning, vData_List.DLibelle, vData_List.DAbreviation);
        }
