<%@ Page Language="C#" MasterPageFile="~/PL/PL_MasterPage.master" AutoEventWireup="true"
 CodeFile="APL_V_PL0_Utilisateur.aspx.cs" Inherits="APL_V_PL0_Utilisateur" Title="" %>
        ...
        <li id="liste_0">
            <ul>
              <li ID="FFiltersTab_0" class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" ClientIDMode="Static" runat="server">
                    <ul>
                        <li>Filtres</li>
<%--                        <li><TBfr:PL_CheckBox ID="FiltreModif_0" Caption='<%# TemplateLabelValue(0,"LblFilterModif")%>' ClientIDMode="Static" runat="server" /></li>
...
<%--              <columns>
                    ...
                    <dx:GridViewDataCheckColumn Name="cModif" />
...
<%--            <SettingsBehavior ConfirmDelete="true" />--%>
                ...
                <Templates>
                    <%--<PreviewRow>
                        <ul>
<li>
                                    <TBfr:PL_TextBox D="PV_Modif_0" Valeur='<%# TemplateColId(0,"PV_Modif")%>' Caption='<%# TemplateLabelValue(0,"LblModif")%>' ClientIDMode="Static" runat="server" />
...
<li>
            <TBfr:PL_CheckBox ID="EF_Modif_0" Valeur='<%# TemplateStringValue(0,"Modif","EF_Modif_0")%>' Caption='<%# TemplateLabelValue(0,"LblModif")%>' ClientIDMode="Static" runat="server" />      
      <TBfr:PL_TextBox ID="EF_Lib_Modif_0" Valeur='<%# TemplateStringValue(0,"Modif","EF_Lib_Modif_0")%>' Caption='<%# TemplateLabelValue(0,"LblModif")%>' ClientIDMode="Static" runat="server" />      
...
<li>
            <TBfr:PL_CheckBox ID="Modif_0" Valeur='<%# TemplateStringValue(0,"Modif","Modif_0")%>' Caption='<%# TemplateLabelValue(0,"LblModif")%>' ClientIDMode="Static" runat="server" />      
      <TBfr:PL_TextBox ID="Lib_Modif_0" Valeur='<%# TemplateStringValue(0,"Modif","Lib_Modif_0")%>' Caption='<%# TemplateLabelValue(0,"LblModif")%>' ClientIDMode="Static" runat="server" />      
...
<ul>
        <li class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" clientidmode="Static" runat="server">
            <ul class="TBfr_ACCORDION_GROUP_COLLAPSED_JS">
                ...
                <li><a href="../PL/APL_V_PL0_Utilisateur.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=0">Défaut</a></li>
                <li><a href="../PL/APL_V_PL0_Utilisateur.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=1">Detail seul</a></li>
                <li><a href="../PL/APL_V_PL0_Utilisateur.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=2">Batch</a></li>
                <li><a href="../PL/APL_V_PL0_Utilisateur.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=3">PopupEditForm</a></li>
                <li><a href="../PL/APL_V_PL0_Utilisateur.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=4">Liste/Detail</a></li>
                <li><a href="../PL/APL_V_PL0_Utilisateur.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=5">Inline</a></li>
            </ul>
        </li>
    </ul>
</asp:Content>
