<%@ Page Language="C#" MasterPageFile="~/PL/PL_MasterPage.master" AutoEventWireup="true"
 CodeFile="APL_V_PL0_Categorie.aspx.cs" Inherits="APL_V_PL0_Categorie" Title="" %>
        ...
        <li id="liste_0">
            <ul>
              <li ID="FFiltersTab_0" class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" ClientIDMode="Static" runat="server">
                    <ul>
                        <li>Filtres</li>
<%--                        <li><TBfr:PL_ComboBox ID="FiltreId_typecategorie_0" Caption='<%# TemplateLabelValue(0,"LblFilterId_typecategorie")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:PL_ComboBox ID="FiltreId_mere_0" Caption='<%# TemplateLabelValue(0,"LblFilterId_mere")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:PL_TextBox ID="FiltreLibelle_0" Caption='<%# TemplateLabelValue(0,"LblFilterLibelle")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:PL_TextBox ID="FiltreOrdreaff_0" Caption='<%# TemplateLabelValue(0,"LblFilterOrdreaff")%>' ClientIDMode="Static" runat="server" /></li>--%>
...
<%--                        <li><TBfr:PL_TextBox ID="FiltreLib_typecategorie_0" Caption='<%# TemplateLabelValue(0,"LblFilterLib_typecategorie")%>' ClientIDMode="Static" runat="server" /></li>
                        ...
                        <li><TBfr:PL_TextBox ID="FiltreLib_mere_0" Caption='<%# TemplateLabelValue(0,"LblFilterLib_mere")%>' ClientIDMode="Static" runat="server" /></li>--%>
...
<%--              <columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Name="cId_typecategorie" />
                    <dx:GridViewDataComboBoxColumn Name="cId_mere" />
                    <dx:GridViewDataTextColumn Name="cLibelle" />
                    <dx:GridViewDataTextColumn Name="cOrdreaff" />
                    ...
                    <dx:GridViewDataTextColumn Name="cLib_mere" />
...
<%--            <SettingsBehavior ConfirmDelete="true" />--%>
                ...
                <Templates>
                    <%--<PreviewRow>
                        <ul>
<li>
                                    <TBfr:PL_TextBox D="PV_Id_typecategorie_0" Valeur='<%# TemplateColId(0,"PV_Id_typecategorie")%>' Caption='<%# TemplateLabelValue(0,"LblId_typecategorie")%>' ClientIDMode="Static" runat="server" />

</li>
<li>
                                    <TBfr:PL_TextBox D="PV_Id_mere_0" Valeur='<%# TemplateColId(0,"PV_Id_mere")%>' Caption='<%# TemplateLabelValue(0,"LblId_mere")%>' ClientIDMode="Static" runat="server" />
...
<li>
                                    <TBfr:PL_TextBox D="PV_Ordreaff_0" Valeur='<%# TemplateColId(0,"PV_Ordreaff")%>' Caption='<%# TemplateLabelValue(0,"LblOrdreaff")%>' ClientIDMode="Static" runat="server" />
...
<li>
                                    <TBfr:PL_TextBox D="PV_Lib_mere_0" Valeur='<%# TemplateColId(0,"PV_Lib_mere")%>' Caption='<%# TemplateLabelValue(0,"LblLib_mere")%>' ClientIDMode="Static" runat="server" />
...
<li>
            <TBfr:PL_ComboBox ID="EF_Id_typecategorie_0" Valeur='<%# TemplateStringValue(0,"Id_typecategorie","EF_Id_typecategorie_0")%>' Caption='<%# TemplateLabelValue(0,"LblId_typecategorie")%>' ClientIDMode="Static" runat="server" />      

</li>
<li>
            <TBfr:PL_ComboBox ID="EF_Id_mere_0" Valeur='<%# TemplateStringValue(0,"Id_mere","EF_Id_mere_0")%>' Caption='<%# TemplateLabelValue(0,"LblId_mere")%>' ClientIDMode="Static" runat="server" />      
...
<li>
             <TBfr:PL_TextBox ID="EF_Ordreaff_0" Valeur='<%# TemplateStringValue(0,"Ordreaff","EF_Ordreaff_0")%>' Caption='<%# TemplateLabelValue(0,"LblOrdreaff")%>' ClientIDMode="Static" runat="server" />      
...
<li>
             <TBfr:PL_TextBox ID="EF_Lib_mere_0" Valeur='<%# TemplateStringValue(0,"Lib_mere","EF_Lib_mere_0")%>' Caption='<%# TemplateLabelValue(0,"LblLib_mere")%>' ClientIDMode="Static" runat="server" />      
        ...
        <asp:SqlDataSource ID="SqlDataSourceGridId_typecategorie_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />
        <asp:SqlDataSource ID="SqlDataSourceGridId_mere_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />
        ...
        <asp:SqlDataSource ID="SqlDataSourceFiltreId_typecategorie_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />
        <asp:SqlDataSource ID="SqlDataSourceFiltreId_mere_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />
...
<li>
            <TBfr:PL_ComboBox ID="Id_typecategorie_0" Valeur='<%# TemplateStringValue(0,"Id_typecategorie","Id_typecategorie_0")%>' Caption='<%# TemplateLabelValue(0,"LblId_typecategorie")%>' ClientIDMode="Static" runat="server" />      

</li>
<li>
            <TBfr:PL_ComboBox ID="Id_mere_0" Valeur='<%# TemplateStringValue(0,"Id_mere","Id_mere_0")%>' Caption='<%# TemplateLabelValue(0,"LblId_mere")%>' ClientIDMode="Static" runat="server" />      
...
<li>
             <TBfr:PL_TextBox ID="Ordreaff_0" Valeur='<%# TemplateStringValue(0,"Ordreaff","Ordreaff_0")%>' Caption='<%# TemplateLabelValue(0,"LblOrdreaff")%>' ClientIDMode="Static" runat="server" />      
...
<li>
             <TBfr:PL_TextBox ID="Lib_mere_0" Valeur='<%# TemplateStringValue(0,"Lib_mere","Lib_mere_0")%>' Caption='<%# TemplateLabelValue(0,"LblLib_mere")%>' ClientIDMode="Static" runat="server" />      
...
<%--Sources des combo box de fiche UNIQUEMENT POUR _editpopup et editformrow--%>
        <asp:SqlDataSource ID="SqlDataSourceId_typecategorie_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />
        <asp:SqlDataSource ID="SqlDataSourceId_mere_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />
...
<ul>
        <li class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" clientidmode="Static" runat="server">
            <ul class="TBfr_ACCORDION_GROUP_COLLAPSED_JS">
                ...
                <li><a href="../PL/APL_V_PL0_Categorie.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=0">Défaut</a></li>
                <li><a href="../PL/APL_V_PL0_Categorie.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=1">Detail seul</a></li>
                <li><a href="../PL/APL_V_PL0_Categorie.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=2">Batch</a></li>
                <li><a href="../PL/APL_V_PL0_Categorie.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=3">PopupEditForm</a></li>
                <li><a href="../PL/APL_V_PL0_Categorie.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=4">Liste/Detail</a></li>
                <li><a href="../PL/APL_V_PL0_Categorie.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=5">Inline</a></li>
            </ul>
        </li>
    </ul>
</asp:Content>
