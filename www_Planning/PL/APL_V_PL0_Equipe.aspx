<%@ Page Language="C#" MasterPageFile="~/PL/PL_MasterPage.master" AutoEventWireup="true"
    CodeFile="APL_V_PL0_Equipe.aspx.cs" Inherits="APL_V_PL0_Equipe" Title="" %>
...
<asp:Content ID="ContentForm" ContentPlaceHolderID="PlaceHolderForm" runat="server">
    <ul>
        <li>
            <TBfr:PL_Label ID="FCurrentStateDisplay_0" CssClass="PL_CurrentStateDisplay" ClientIDMode="Static" runat="server" /></li>
        <li>
            <TBfr:PL_Label ID="FMessageDisplay_0" CssClass="PL_MessageDisplay" ClientIDMode="Static" runat="server" /></li>
    </ul>
    <ul>
            ...
            <ul>
                <li id="FFiltersTab_0" class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" clientidmode="Static" runat="server">
                    <ul>
                        <li>Filtres</li>
                        <li>
                            <TBfr:PL_ComboBox ID="FiltreId_planning_0" Caption='<%# TemplateLabelValue(0,"LblFilterId_planning")%>' OnSelectedIndexChanged="FPFiltreId_planning_0_SelectedIndexChanged" ClientIDMode="Static" runat="server" />
                        </li>
                       ...
                       <li><TBfr:PL_TextBox ID="FiltreLib_planning_0" Caption='<%# TemplateLabelValue(0,"LblFilterLib_planning")%>' ClientIDMode="Static" runat="server" /></li>
                        ...
                        --%>
                        <li>
                            <TBfr:PL_Button ID="FFilterButton_0" Text='<%# TemplateButtonText("IconFilterButton", 1)%>' ToolTip='<%# TemplateButtonText("TextFilterButton", 0)%>' ClientIDMode="Static" runat="server" />
                        </li>
                        <li>
                            <TBfr:PL_Button ID="FEmptyFiltersButton_0" Text='<%# TemplateButtonText("IconEmptyFiltersButton", 1)%>' ToolTip='<%# TemplateButtonText("TextEmptyFiltersButton", 0)%>' ClientIDMode="Static" runat="server" />
                        </li>
                    </ul>
                </li>
            </ul>
...
<li>
                    ...
                    <EditForm>
                        ...
                        <ul class="PL_Master_EditForm">
                            <li>
                                <TBfr:PL_TextBox ID="EF_AffId_0" Valeur='<%# TemplateStringValue(0,"Id","EF_AffId_0")%>' ReadOnly="true" ClientIDMode="Static" runat="server" />
                            </li>
                            <li>
                                <TBfr:PL_Label ID="Lib_Delete_0" Valeur='<%# TemplateStringValue(0,"Lib_Delete","Lib_Delete_0")%>' ReadOnly="true" ClientIDMode="Static" runat="server" /></li>
                            <li>
        ...
        <li id="detail_0">
            ...
            <ul class="PL_Master_EditForm">
                <li>
                    <TBfr:PL_TextBox ID="AffId_0" Valeur='<%# TemplateStringValue(0,"Id", "AffId_0")%>' ReadOnly="true" ClientIDMode="Static" runat="server" />
                </li>
                <li>
...
<asp:Content ID="ContentSideMenu" runat="server" ContentPlaceHolderID="PlaceHolderSideMenu">
    ...
    <ul>
        <li>
            <TBfr:PL_Button ID="FCreateButton_0" Text='<%# TemplateButtonText("IconCreateButton", 1)%>' ClientIDMode="Static" runat="server" />
        </li>
        <li>
            <TBfr:PL_Button ID="FVisualizeButton_0" Text='<%# TemplateButtonText("IconViewButton", 1)%>' ClientIDMode="Static" runat="server" />
        </li>
        <li>
            <TBfr:PL_Button ID="FDuplicateButton_0" Text='<%# TemplateButtonText("IconDuplicateButton", 1)%>' ClientIDMode="Static" runat="server" />
        </li>
        <li>
            <TBfr:PL_Button ID="FUpdateButton_0" Text='<%# TemplateButtonText("IconUpdateButton", 1)%>' ClientIDMode="Static" runat="server" />
        </li>
        <li>
            <TBfr:PL_Button ID="FDeleteButton_0" Text='<%# TemplateButtonText("IconDeleteButton", 1)%>' ClientIDMode="Static" runat="server" />
        </li>
        <li>
            <TBfr:PL_Button ID="FValidateButton_0" Text='<%# TemplateButtonText("IconValidateButton", 1)%>' ClientIDMode="Static" runat="server" />
        </li>
        <li>
            <TBfr:PL_Button ID="FCancelButton_0" Text='<%# TemplateButtonText("IconCancelButton", 1)%>' ClientIDMode="Static" runat="server" />
        </li>
        <li>
            <TBfr:PL_Button ID="FEraseButton_0" Text='<%# TemplateButtonText("IconEraseButton", 1)%>' ClientIDMode="Static" runat="server" />
        </li>
    </ul>
    <ul>
        <li>
    ...
    <ul>
        <li class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" clientidmode="Static" runat="server">
            <ul class="TBfr_ACCORDION_GROUP_COLLAPSED_JS">
                ...
                <li><a href="../PL/APL_V_PL0_Equipe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=0">Défaut</a></li>
                <li><a href="../PL/APL_V_PL0_Equipe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=1">Detail seul</a></li>
                <li><a href="../PL/APL_V_PL0_Equipe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=2">Batch</a></li>
                <li><a href="../PL/APL_V_PL0_Equipe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=3">PopupEditForm</a></li>
                <li><a href="../PL/APL_V_PL0_Equipe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=4">Liste/Detail</a></li>
                <li><a href="../PL/APL_V_PL0_Equipe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=5">Inline</a></li>
            </ul>
        </li>
    </ul>
</asp:Content>
