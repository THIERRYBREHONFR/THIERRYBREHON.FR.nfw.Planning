...
public partial class PL_PopupExport : System.Web.UI.UserControl
{

    public void Page_LoadLinkEvents(System.EventHandler gridExport_click) { FExportButton.Click += gridExport_click; }
    ...
    public bool CompatibiliteImportVisible { set { FCompatibiliteImport.Visible = value; FExpImp.Checked = false; } }
    public bool LikeOnScreenVisible { set => FLikeOnScreenVisible.Visible = value; }
}