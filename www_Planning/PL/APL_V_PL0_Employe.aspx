<%@ Page Language="C#" MasterPageFile="~/PL/PL_MasterPage.master" AutoEventWireup="true"
 CodeFile="APL_V_PL0_Employe.aspx.cs" Inherits="APL_V_PL0_Employe" Title="" %>
...
<%--                        <li><TBfr:PL_TextBox ID="FiltreInitiales_0" Caption='<%# TemplateLabelValue(0,"LblFilterInitiales")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:PL_TextBox ID="FiltreNom_0" Caption='<%# TemplateLabelValue(0,"LblFilterNom")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:PL_TextBox ID="FiltrePrenom_0" Caption='<%# TemplateLabelValue(0,"LblFilterPrenom")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:PL_CheckBox ID="FiltreFeminin_0" Caption='<%# TemplateLabelValue(0,"LblFilterFeminin")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:PL_ComboBox ID="FiltreId_utilisateur_0" Caption='<%# TemplateLabelValue(0,"LblFilterId_utilisateur")%>' ClientIDMode="Static" runat="server" /></li>
                        <li><TBfr:PL_TextBox ID="FiltreIdentite_0" Caption='<%# TemplateLabelValue(0,"LblFilterIdentite")%>' ClientIDMode="Static" runat="server" /></li>
...
<%--              <columns>
                    ...
                    <dx:GridViewDataTextColumn Name="cInitiales" />
                    <dx:GridViewDataComboBoxColumn Name="cId_planning" />
                    <dx:GridViewDataTextColumn Name="cNom" />
                    <dx:GridViewDataTextColumn Name="cPrenom" />
                    <dx:GridViewDataCheckColumn Name="cFeminin" />
                    <dx:GridViewDataComboBoxColumn Name="cId_utilisateur" />
                    <dx:GridViewDataTextColumn Name="cIdentite" />
...
<%--            <SettingsBehavior ConfirmDelete="true" />--%>
                ...
                <Templates>
                    <%--<PreviewRow>
                        <ul>
<li>
                                    <TBfr:PL_TextBox D="PV_Initiales_0" Valeur='<%# TemplateColId(0,"PV_Initiales")%>' Caption='<%# TemplateLabelValue(0,"LblInitiales")%>' ClientIDMode="Static" runat="server" />
...
<li>
                                    <TBfr:PL_TextBox D="PV_Nom_0" Valeur='<%# TemplateColId(0,"PV_Nom")%>' Caption='<%# TemplateLabelValue(0,"LblNom")%>' ClientIDMode="Static" runat="server" />

</li>
<li>
                                    <TBfr:PL_TextBox D="PV_Prenom_0" Valeur='<%# TemplateColId(0,"PV_Prenom")%>' Caption='<%# TemplateLabelValue(0,"LblPrenom")%>' ClientIDMode="Static" runat="server" />

</li>
<li>
                                    <TBfr:PL_TextBox D="PV_Feminin_0" Valeur='<%# TemplateColId(0,"PV_Feminin")%>' Caption='<%# TemplateLabelValue(0,"LblFeminin")%>' ClientIDMode="Static" runat="server" />

</li>
<li>
                                    <TBfr:PL_TextBox D="PV_Id_utilisateur_0" Valeur='<%# TemplateColId(0,"PV_Id_utilisateur")%>' Caption='<%# TemplateLabelValue(0,"LblId_utilisateur")%>' ClientIDMode="Static" runat="server" />

</li>
<li>
                                    <TBfr:PL_TextBox D="PV_Identite_0" Valeur='<%# TemplateColId(0,"PV_Identite")%>' Caption='<%# TemplateLabelValue(0,"LblIdentite")%>' ClientIDMode="Static" runat="server" />
...
<li>
             <TBfr:PL_TextBox ID="EF_Initiales_0" Valeur='<%# TemplateStringValue(0,"Initiales","EF_Initiales_0")%>' Caption='<%# TemplateLabelValue(0,"LblInitiales")%>' ClientIDMode="Static" runat="server" />      
...
<li>
             <TBfr:PL_TextBox ID="EF_Nom_0" Valeur='<%# TemplateStringValue(0,"Nom","EF_Nom_0")%>' Caption='<%# TemplateLabelValue(0,"LblNom")%>' ClientIDMode="Static" runat="server" />      

</li>
<li>
             <TBfr:PL_TextBox ID="EF_Prenom_0" Valeur='<%# TemplateStringValue(0,"Prenom","EF_Prenom_0")%>' Caption='<%# TemplateLabelValue(0,"LblPrenom")%>' ClientIDMode="Static" runat="server" />      

</li>
<li>
            <TBfr:PL_CheckBox ID="EF_Feminin_0" Valeur='<%# TemplateStringValue(0,"Feminin","EF_Feminin_0")%>' Caption='<%# TemplateLabelValue(0,"LblFeminin")%>' ClientIDMode="Static" runat="server" />      
      <TBfr:PL_TextBox ID="EF_Lib_Feminin_0" Valeur='<%# TemplateStringValue(0,"Feminin","EF_Lib_Feminin_0")%>' Caption='<%# TemplateLabelValue(0,"LblFeminin")%>' ClientIDMode="Static" runat="server" />      
 
</li>
<li>
            <TBfr:PL_ComboBox ID="EF_Id_utilisateur_0" Valeur='<%# TemplateStringValue(0,"Id_utilisateur","EF_Id_utilisateur_0")%>' Caption='<%# TemplateLabelValue(0,"LblId_utilisateur")%>' ClientIDMode="Static" runat="server" />      

</li>
<li>
             <TBfr:PL_TextBox ID="EF_Identite_0" Valeur='<%# TemplateStringValue(0,"Identite","EF_Identite_0")%>' Caption='<%# TemplateLabelValue(0,"LblIdentite")%>' ClientIDMode="Static" runat="server" />      
...
<li>
        ...
        <asp:SqlDataSource ID="SqlDataSourceGridId_utilisateur_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />
...
<%--        <asp:SqlDataSource ID="SqlDataSourceFiltreId_planning_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />--%>
        <asp:SqlDataSource ID="SqlDataSourceFiltreId_utilisateur_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />
...
<li>
             <TBfr:PL_TextBox ID="Initiales_0" Valeur='<%# TemplateStringValue(0,"Initiales","Initiales_0")%>' Caption='<%# TemplateLabelValue(0,"LblInitiales")%>' ClientIDMode="Static" runat="server" />      
...
<li>
             <TBfr:PL_TextBox ID="Nom_0" Valeur='<%# TemplateStringValue(0,"Nom","Nom_0")%>' Caption='<%# TemplateLabelValue(0,"LblNom")%>' ClientIDMode="Static" runat="server" />      

</li>
<li>
             <TBfr:PL_TextBox ID="Prenom_0" Valeur='<%# TemplateStringValue(0,"Prenom","Prenom_0")%>' Caption='<%# TemplateLabelValue(0,"LblPrenom")%>' ClientIDMode="Static" runat="server" />      

</li>
<li>
            <TBfr:PL_CheckBox ID="Feminin_0" Valeur='<%# TemplateStringValue(0,"Feminin","Feminin_0")%>' Caption='<%# TemplateLabelValue(0,"LblFeminin")%>' ClientIDMode="Static" runat="server" />      
      <TBfr:PL_TextBox ID="Lib_Feminin_0" Valeur='<%# TemplateStringValue(0,"Feminin","Lib_Feminin_0")%>' Caption='<%# TemplateLabelValue(0,"LblFeminin")%>' ClientIDMode="Static" runat="server" />      
 
</li>
<li>
            <TBfr:PL_ComboBox ID="Id_utilisateur_0" Valeur='<%# TemplateStringValue(0,"Id_utilisateur","Id_utilisateur_0")%>' Caption='<%# TemplateLabelValue(0,"LblId_utilisateur")%>' ClientIDMode="Static" runat="server" />      

</li>
<li>
             <TBfr:PL_TextBox ID="Identite_0" Valeur='<%# TemplateStringValue(0,"Identite","Identite_0")%>' Caption='<%# TemplateLabelValue(0,"LblIdentite")%>' ClientIDMode="Static" runat="server" />      
...
<%--Sources des combo box de fiche UNIQUEMENT POUR _editpopup et editformrow--%>
        ...
        <asp:SqlDataSource ID="SqlDataSourceId_utilisateur_0" ConnectionString="<%$ ConnectionStrings:SqlConnectionDataPL %>" runat="server" />
...
<ul>
        <li class="TBfr_ACCORDION_GROUP_JS TBfr_ACCORDION_GROUP_CSS" clientidmode="Static" runat="server">
            <ul class="TBfr_ACCORDION_GROUP_COLLAPSED_JS">
                ...
                <li><a href="../PL/APL_V_PL0_Employe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=0">Défaut</a></li>
                <li><a href="../PL/APL_V_PL0_Employe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=1">Detail seul</a></li>
                <li><a href="../PL/APL_V_PL0_Employe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=2">Batch</a></li>
                <li><a href="../PL/APL_V_PL0_Employe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=3">PopupEditForm</a></li>
                <li><a href="../PL/APL_V_PL0_Employe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=4">Liste/Detail</a></li>
                <li><a href="../PL/APL_V_PL0_Employe.aspx?code=<%=IdAndCodeSession%>&<%=C_Query_WebFormMode%>=5">Inline</a></li>
            </ul>
        </li>
    </ul>
</asp:Content>
