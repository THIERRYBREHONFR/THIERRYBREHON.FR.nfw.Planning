    ...
    <ContentCollection>
        <dx:PopupControlContentControl>
            <ul>
                ...
                <li>
                    <TBfr:ET_TextBox ID="FNomModeleSave" ClientIDMode="static" runat="server" />
                </li>
                <li>Ou modifier le modèle choisi dans la liste déroulante : </li>
                <li>
                    <TBfr:ET_ComboBox ID="FId_ModeleSave"
                ...
                <li>
                    <TBfr:ET_Button ID="FOKSaveModel" Text="Enregistrer" Width="100px" runat="server">
                        <ClientSideEvents Click="function(s, e) { FSaveModelPopup.Hide(); }" />
                    </TBfr:ET_Button>
                </li>
                <li>
                    <TBfr:ET_Button ID="FCancelSaveModel" Text="Annuler" Width="100px" AutoPostBack="False" runat="server">
                        <ClientSideEvents Click="function(s, e) { FSaveModelPopup.Hide(); }" />
                    </TBfr:ET_Button>
                </li>
            </ul>
        ...
        <dx:PopupControlContentControl>
            <table>
                <tr id="MdlStd" runat="server" visible="true">
                    ...
                    <td>
                        <TBfr:ET_ComboBox runat="server" ID="FId_ModeleStd" ClientInstanceName="FId_ModeleStd"
                ...
                <tr id="MdlPerso" runat="server" visible="true">
                    ...
                    <td>
                        <TBfr:ET_ComboBox runat="server" ID="FId_ModelePerso" ClientInstanceName="FId_ModelePerso"
                ...
                <tr id="MdlAutre" runat="server" visible="true">
                    ...
                    <td>
                        <TBfr:ET_ComboBox runat="server" ID="FId_ModeleAutre" ClientInstanceName="FId_ModeleAutre"
