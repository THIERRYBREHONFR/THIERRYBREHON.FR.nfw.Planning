                 ...
                 <tr id="FCompatibiliteImport" runat="server" visible="false">
                        ...
                        <td style="background-color: #DDDDDD; vertical-align: top;">
                            <table>
                              <tr>
                                   <td colspan="4">
                                        <TBfr:ET_CheckBox ID="FExpImp" Checked="false" ClientInstanceName="PExpImp" 
                        ...
                        <td style="background-color: #DDDDDD; vertical-align: top;">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <TBfr:ET_RadioButton ID="FPdf" Checked="false" ClientInstanceName="PPdf" GroupName="FormatFichier"
                                            Text="*.pdf" runat="server" />
                                    </td>
                                    <td>
                                        <TBfr:ET_RadioButton ID="FXls" Checked="false" ClientInstanceName="PXls" GroupName="FormatFichier"
                                            Text="*.xls" runat="server" />
                                    </td>
                                    <td>
                                        <TBfr:ET_RadioButton ID="FXlsx" Checked="false" ClientInstanceName="PXlsX" GroupName="FormatFichier"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <TBfr:ET_RadioButton ID="FCsv" Checked="false" ClientInstanceName="PCsv" GroupName="FormatFichier"
                                            Text="*.csv" runat="server" visible="false" />
                                    </td>
                                    <td>
                                        <TBfr:ET_RadioButton ID="FXlsBrut" Checked="false" ClientInstanceName="PXlsBrut" GroupName="FormatFichier"
                                            Text="*.xls" runat="server" />
                                    </td>
                                    <td>
                                        <TBfr:ET_RadioButton ID="FXlsxBrut" Checked="true" ClientInstanceName="PXlsxBrut"
