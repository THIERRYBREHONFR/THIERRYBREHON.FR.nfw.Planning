<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Landing - Copier.aspx.cs" Inherits="Landing" %>
...
<body>
    <form id="form0" runat="server">
        ...
        <ul class="ET_Sommaire_MenuPrincipal">
            ...
            <li id="Div_PT" runat="server"><a href="../PT/PT_Sommaire.aspx?code=<%=IdAndCodeSession%>">
                <img src="../PT/Images/logo_appli.JPG" alt="Planning" title="Planning" /></a></li>
